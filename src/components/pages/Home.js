                        ...
                        <div className="container">
                            <div className="row">
                                <div className="4u 12u$(medium)">
                                    <header>
                                        <h2 className="h3">Городской туризм</h2>
                                ...
                                <div className="4u 12u$(medium)">
                                    <p className="p1">В последнее время проблемам городского туризма как одному из перспективных
                                ...
                                <div className="4u$ 12u$(medium)">
                                    <p className="p1">Наиболее крупным является деление городских туристских центров на две группы:
